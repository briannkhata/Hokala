...
namespace Hokala
{
    public partial class frmLogin : Form
    {
        ...
        private void VisibleMenu()
        {
            ...
            HokalaToolStripMenuItem.Visible = false;
        ...
        public void  ViewMenu()
        {
          ...
          //  transactionToolStripMenuItem.Visible = true;
            HokalaToolStripMenuItem.Visible = true;

        }
        public frmLogin(string title, string txt)
        {
            InitializeComponent();
            this.Text = title;
        ...
        private void HokalaToolStripMenuItem_Click(object sender, EventArgs e)
        {
